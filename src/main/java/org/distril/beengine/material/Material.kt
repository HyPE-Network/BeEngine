...
enum class Material(val itemRuntimeId: Int) {
	...
	val identifier: String = ItemPalette.getIdentifier(this.itemRuntimeId)

	val isBlock = BlockPalette.isBlock(this)

	fun <T : Item> getItem(): T = Server.itemRegistry.from(this)

	fun <T : Block> getBlock(): T = Server.blockRegistry.from(this)

	fun <T : Block> getBlock(state: BlockState): T = Server.blockRegistry.from(this, state)

	companion object {

		private val BY_ITEM_RUNTIME_ID = mutableMapOf<Int, Material>()
